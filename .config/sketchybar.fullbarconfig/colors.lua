...
-- Brighter, still-monochrome variant used to mark the currently focused
-- workspace so it stands out from the rest without breaking the palette.
colors.island_active = {
	color = colors.with_alpha(colors.white, 0.14),
